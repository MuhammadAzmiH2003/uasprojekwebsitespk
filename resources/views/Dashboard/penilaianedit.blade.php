...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-3">
          <div class="col-sm-6">
            <span class="m-0 ">Edit Data Penilaian</span>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-10 mx-auto">
            <div class="card ">
              <div class="card-header">
                <h3 class="text-center ">Edit Data Penilaian</h3>
              </div>
             <!-- form start -->
             <form action="{{ url('/penilaianupdate/update/'.$penilaian->id) }}" method="post" enctype="multipart/form-data">
                @csrf
               @method('put')
                  <div class="card-body">
